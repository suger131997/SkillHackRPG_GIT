...
public class DrawTitleMenu {
	...
	public void drawMunu_Select_Start(ShareInfo sinfo){
		//描画処理
		drawMunu_Select(sinfo);
		drawMunu_Select_arrow(sinfo,0);
		sinfo.DF.drawFrame(sinfo.g,250, 80, 500, 100);
		sinfo.DSP.drawString(sinfo.g, "ほうけんのしよいち", 280, 100, FONT_SIZE.SMALL);
		sinfo.DSP.drawString(sinfo.g, "ほうけんのしよに", 280, 118, FONT_SIZE.SMALL);
		sinfo.DSP.drawString(sinfo.g, "ほうけんのしよさん", 280, 136, FONT_SIZE.SMALL);
	}
	...
	public void drawMunu_Select_Continue(ShareInfo sinfo){
		//描画処理
		drawMunu_Select(sinfo);
		drawMunu_Select_arrow(sinfo,0);
		sinfo.DF.drawFrame(sinfo.g,250, 98, 500, 100);
		sinfo.DSP.drawString(sinfo.g, "ほうけんのしよいち", 280, 118, FONT_SIZE.SMALL);
		sinfo.DSP.drawString(sinfo.g, "ほうけんのしよに", 280, 136, FONT_SIZE.SMALL);
		sinfo.DSP.drawString(sinfo.g, "ほうけんのしよさん", 280, 154, FONT_SIZE.SMALL);
	}
